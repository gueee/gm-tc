  ...
  const plotLayout = useMemo((): Partial<Plotly.Layout> => {
    ...
    return {
      ...
      xaxis: {
        ...
        showspikes: block.showSpikelines === true,
        spikemode: block.showSpikelines ? 'across' : undefined,
        spikethickness: block.showSpikelines ? 1 : undefined,
        spikecolor: block.showSpikelines ? '#D4A574' : undefined,
